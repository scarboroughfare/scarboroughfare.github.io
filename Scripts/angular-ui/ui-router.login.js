...
exports["default"] = function () {
    ...
    var authModule = "$authentication";
    var authClearMethod = "clearAuthKey";
    var authGetMethod = "getAuthKey";
    var cookieName = "__loginData";
    var defaultLoggedInState = null;
    ...
    var Login = (function () {
        ...
        function Login($authentication, ipCookie, $state) {
        ...
        _createClass(Login, [{
            key: "checkLoggedIn",
            value: function checkLoggedIn(currentState, currentParams) {
                var saveCurrentState = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
            ...
            value: function getLoginRedirect() {
                ...
                var cookie = this._ipCookie(cookieName);
                if (_lodash._.isPlainObject(cookie) === false) {
                ...
                if (_lodash._.isPlainObject(params) === false) {
                    params = {};
                }
            ...
            value: function logout() {
                var redirectState = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
    ...
    this.setAuthModule = function (module) {

        if (_lodash._.isString(module)) {
            authModule = module;
        }
     ...
     * @returns {*}
     */
    this.setAuthClearMethod = function (method) {

        if (_lodash._.isString(method)) {
     ...
     * @returns {*}
     */
    this.setAuthGetMethod = function (method) {
     ...
     * @returns {*}
     */
    this.setDefaultLoggedInState = function (state) {

        if (_lodash._.isString(state) && _lodash._.isEmpty(state) === false) {
     ...
     * @returns {*}
     */
    this.setFallbackState = function (state) {
    ...
    this.$get = ["$injector", "ipCookie", "$state", function ($injector, ipCookie, $state) {
        ...
        if (_lodash._.isNull(fallbackState)) {
...
},{"lodash":2}],4:[function(_dereq_,module,exports){
/**
 * run
 */
...
exports["default"] = ["$rootScope", "$state", "$login", function ($rootScope, $state, $login) {
...
},{"lodash":2}],5:[function(_dereq_,module,exports){
/**
 * app
 */
...
/* Providers */
.provider("$login", _dereq_("./loginProvider"))
